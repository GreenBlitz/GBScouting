...
class ManualTeamNumberInput<Option extends string, Options extends Option[]> extends ScouterInput<TwoOptionAndTeamNumber<Option>, { twoOptions: TwoOptions<Option, Options> }> {
                    ...
                    onChange={async (event) => {
                        ...
                        if (storedTwoOptionAndNumber) {
                            storedTwoOptionAndNumber = {
                                ...
                                option2: storedTwoOptionAndNumber.option2,
                                qualNumber: storedTwoOptionAndNumber.qualNumber,
                                teamNumber: event.target.value as unknown as number
                            };
                            this.storage.set({
                                ...storedTwoOptionAndNumber, 
                            });
